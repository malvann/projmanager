...
(
    ...
    custom_skype       varchar,
    custom_telegramm   integer,
...
(
    ...
    empl_lastname    varchar(20)                         not null,
    empl_password    varchar(20)                         not null,
    empl_mail        varchar(50)                         not null,
